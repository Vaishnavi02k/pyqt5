...
class UI(QMainWindow):
    ...
    def stand(self):
        ...
        if self.dealer_total >= 17:
            ...
            if self.dealer_total >21:
                #check for ace conversion (I am adding this)
    ...
    def toggle_image_visibility(self):
        ...
        self.player_card2.setVisible(self.is_image_visible)
        ...
        if self.dealers_position <= 5 :
            try:
                ...
                if self.dealers_position == 0:
                    ...
                    #self.is_image_visible = False  # Track the visibility status of the
                    self.dealer_card2.setPixmap(pixmap)
                    self.dealers_position+=1
...
# Hide the image after a delay (e.g., 0 seconds)
# You can replace the `3` with the desired delay in seconds
QtCore.QTimer.singleShot(0, UIWindow.toggle_image_visibility)

# Show the image again after a delay (e.g., 6 seconds)
# You can replace the `6` with the desired delay in seconds
QtCore.QTimer.singleShot(6000, UIWindow.toggle_image_visibility)
